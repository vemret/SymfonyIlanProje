...
class UserController extends AbstractController
{
    ...
    /**
     * @Route("/advert", name="user_advert", methods={"GET"})
     */
    public function advert(): Response
    {
        return $this->render('user/advert.html.twig');
    }
    ...
    public function new(Request $request, UserPasswordEncoderInterface $passwordEncoder): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            if ($file) {
                ...
                $user->setImage($fileName); //upload file name
            }
            //***------------******
    ...
    public function newcomment(Request $request, $id): Response
    {
        ...
        if ($form->isSubmitted()) {
            if ($this->isCsrfTokenValid('comment', $submittedToken)) {
                ...
                $this->addFlash('success','your comment has benn sent successfuly');
